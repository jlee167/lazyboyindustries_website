    ...
    if (response.status === 200) {
      response.json().then(function (jsonData) {
        ...
        if (jsonData.registered == true) {
          ...
          var errorMessage = 'Server rejected request.\n' + jsonData.error;
      ...
      response.json().then(function (jsonData) {
        ...
        for (var err in jsonData.errors) {
          jsonData.errors[err].forEach(function (msg) {
...
module.exports = __webpack_require__(/*! /home/admin/LazyWeb/lazyweblaravel/resources/js/auth.js */"./resources/js/auth.js");
